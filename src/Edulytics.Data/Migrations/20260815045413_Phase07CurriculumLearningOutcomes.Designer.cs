...
namespace Edulytics.Data.Migrations
{
    ...
    [Migration("20260815045413_Phase07CurriculumLearningOutcomes")]
    partial class Phase07CurriculumLearningOutcomes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.CurriculumTopic", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "SubjectId", "GradeLevelId", "Name")
                        .IsUnique();

                    b.HasIndex("SchoolId", "SubjectId", "GradeLevelId", "Order")
                        .IsUnique();
