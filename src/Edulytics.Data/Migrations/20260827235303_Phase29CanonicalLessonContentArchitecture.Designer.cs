...
namespace Edulytics.Data.Migrations
{
    ...
    [Migration("20260827235303_Phase29CanonicalLessonContentArchitecture")]
    partial class Phase29CanonicalLessonContentArchitecture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.BankTransferPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReceivedCurrencyCode")
                        .IsRequired()
                        .HasMaxLength(3)
                    ...
                    b.HasIndex("SchoolId", "PaymentReference");

                    b.HasIndex("SchoolId", "InvoiceId", "ReceivedAtUtc");

                    b.ToTable("BankTransferPayments", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.BillingInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("BillingPeriodEndsAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("BillingPeriodStartsAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("InvoiceEmailSnapshot")
                        .IsRequired()
                        .HasMaxLength(320)
                    ...
                    b.Property<string>("LegalNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.Property<string>("PaymentInstructionsSnapshot")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<decimal?>("SettlementEquivalentAmount")
                        .HasPrecision(14, 2)
                        .HasColumnType("numeric(14,2)");
                    ...
                    b.Property<string>("TaxIdentifierSnapshot")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("TaxTreatmentCodeSnapshot")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("SchoolId", "SubscriptionId");

                    b.HasIndex("SchoolId", "Status", "DueDateUtc");

                    b.HasIndex("SubscriptionId", "Kind", "InstallmentNumber")
                        .IsUnique();

                    b.ToTable("BillingInvoices", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.BillingInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("ProrationDenominatorDays")
                        .HasColumnType("integer");

                    b.Property<int?>("ProrationNumeratorDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("SeatDelta")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("ServicePeriodEndsAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ServicePeriodStartsAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("SubscriptionSeatChangeId")
                        .HasColumnType("uuid");

                    b.Property<decimal?>("UnitMonthlyPrice")
                        .HasPrecision(12, 2)
                    ...
                    b.HasIndex("SubscriptionSeatChangeId")
                        .IsUnique();

                    b.HasIndex("SchoolId", "InvoiceId");

                    b.HasIndex("SchoolId", "SubscriptionSeatChangeId");

                    b.ToTable("BillingInvoiceLines", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.BillingRefund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "InvoiceId", "RecordedAtUtc");

                    b.ToTable("BillingRefunds", (string)null);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.SchoolBillingProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DefaultSettlementCurrencyCode")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)");
                    ...
                    b.ToTable("SchoolBillingProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.SchoolSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CommercialCurrency")
                        .HasColumnType("integer");

                    b.Property<int>("CommittedSeats")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("CurrentTermEndsAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("CurrentTermStartsAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("EndedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("NonRenewalRequestedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("PendingRenewalSeats")
                        .HasColumnType("integer");

                    b.Property<decimal>("PricePerStudentPerMonth")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)");
                    ...
                    b.HasIndex("Status", "CurrentTermEndsAtUtc");
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.SubscriptionSeatChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("NewSeats")
                        .HasColumnType("integer");

                    b.Property<int>("PreviousSeats")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SchoolId", "EffectiveAtUtc");

                    b.HasIndex("SchoolId", "SubscriptionId");

                    b.HasIndex("SubscriptionId", "EffectiveAtUtc");

                    b.ToTable("SubscriptionSeatChanges", (string)null);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.BankTransferPayment", b =>
                {
                    b.HasOne("Edulytics.Core.Entities.BillingInvoice", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "InvoiceId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.BillingInvoice", b =>
                {
                    ...
                    b.HasOne("Edulytics.Core.Entities.SchoolSubscription", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "SubscriptionId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.BillingInvoiceLine", b =>
                {
                    ...
                    b.HasOne("Edulytics.Core.Entities.SubscriptionSeatChange", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "SubscriptionSeatChangeId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.BillingRefund", b =>
                {
                    ...
                    b.HasOne("Edulytics.Core.Entities.BankTransferPayment", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "PaymentId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
