...
public sealed class CurriculumLocalizationTests
{
    [Fact]
    public void EnglishAndPolishResourceKeys_Match()
    {
        ...
        var en = LoadKeys(Path.Combine(
            root,
            "src/Edulytics.Web/Resources/CurriculumResource.resx"));

        var pl = LoadKeys(Path.Combine(
            root,
            "src/Edulytics.Web/Resources/CurriculumResource.pl.resx"));
